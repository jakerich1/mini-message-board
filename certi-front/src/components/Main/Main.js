...
function Main() {
    ...
    return (
        ...
        style={{ 
            ...
            backgroundPosition: animate ? '60% 40%' : '30% 30%', 
            backgroundSize: animate ? 'cover' : 'cover', 
            ...
            <nav>
                ...
                <ul>
                    <li>
                        <a href='#foo'><span className='primary'>Home</span></a>
                    </li>
                    <li>
            ...
            <div className='main-content-wrap'>
                ...
                <h2>Turn your local artists into global stars</h2>

                <h2 style={{ marginBottom: '60px' }}>Discover and empower local artists from <br /> your local area and beyond</h2>
